    ...
    <section ref={sectionRef} className="py-12 relative">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-0">
        <div className="max-w-4xl mx-auto">
          <h2 
            className="font-display text-2xl sm:text-3xl font-bold mb-8 text-primary transition-all duration-700"
            style={{
          ...
          <div className="space-y-4">
            {section.questions.map((faq, index) => (
              <details
                key={index}
                className="group rounded-2xl border border-border/50 bg-card/50 backdrop-blur-sm overflow-hidden transition-all duration-500 hover:border-primary/30 hover:bg-card/60"
                style={{
                  opacity: isVisible ? 1 : 0,
              ...
              >
                <summary className="flex items-center justify-between p-6 cursor-pointer list-none">
                  ...
                  <span className="flex-shrink-0 w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center transition-all duration-300 group-open:rotate-45 group-open:bg-primary/20">
        ...
        <section className="py-16 lg:py-24 relative">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-0">
            <div className="max-w-3xl mx-auto text-center">
              <span 
                className="inline-block px-4 py-1.5 rounded-full bg-primary/10 text-primary text-sm font-medium mb-6 transition-all duration-700"
                style={{
              ...
              <h1 
                className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 transition-all duration-700"
                style={{
                  opacity: headerVisible ? 1 : 0,
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-0">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  href="mailto:support@lokario.fr"
                  className="inline-flex items-center justify-center px-6 py-3 rounded-full bg-primary text-primary-foreground font-medium hover:bg-primary/90 hover:scale-105 transition-all duration-300"
                >
                  support@lokario.fr
                </a>
              </div>
