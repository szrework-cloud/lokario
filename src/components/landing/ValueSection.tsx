    ...
    <section ref={sectionRef} className="py-24 md:py-32 relative overflow-hidden bg-black">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <div
            className={`grid grid-cols-1 md:grid-cols-3 gap-6 mb-16 transition-all duration-1000 delay-300 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
          >
          ...
          <div
            className={`bg-[#1E293B]/30 backdrop-blur-sm border border-white/5 rounded-3xl p-8 md:p-12 transition-all duration-1000 delay-500 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
          >
