...
export const LandingHowItWorks = () => {
  return (
    <section id="how-it-works" className="py-20 lg:py-32 relative bg-black">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 text-white">
            Simple comme{" "}
            <span className="text-[#F97316]">1, 2, 3</span>
          </h2>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            {/* Connection line */}
            <div className="hidden lg:block absolute left-[60px] top-12 bottom-12 w-0.5 bg-gradient-to-b from-[#F97316] via-[#F97316]/50 to-[#F97316]" />
              ...
              {steps.map((step, index) => (
                ...
                >
                  ...
                  <div className="flex-shrink-0">
                    <div className="w-[120px] h-[120px] rounded-2xl bg-gradient-to-br from-[#F97316] to-[#EA580C] flex items-center justify-center shadow-lg shadow-[#F97316]/20">
                  ...
                  <div className="flex-1 lg:pt-6">
                    ...
                    {index < steps.length - 1 && (
                      <div className="lg:hidden flex items-center gap-2 mt-4 text-[#F97316]">
