...
def get_quote_pdf(
    ...
    try:
        ...
        # Le PDF archivé était créé avec l'ancien code et n'avait pas le logo visible.
        # En servant toujours le PDF régénéré, on garantit que le logo et les images sont toujours corrects.
